...
<head>
  ...
  <!-- Tesseract: intenta local y, si no existe, usa CDN -->
  <script src="libs/tesseract.min.js"></script>
  <script>
    if (!window.Tesseract) {
      document.write('<script src="https://unpkg.com/tesseract.js@5.1.0/dist/tesseract.min.js"><\\/script>');
    }
  </script>

  <!-- XLSX: intenta local y, si no existe, usa CDN -->
  <script src="libs/xlsx.full.min.js"></script>
  <script>
    if (!window.XLSX) {
      document.write('<script src="https://cdn.jsdelivr.net/npm/xlsx@0.20.2/dist/xlsx.full.min.js"><\\/script>');
    }
  </script>
</head>
